...
| Operação SOAP | `AtualizarStatusProcesso` |
...
| 4 | Chamar `AtualizarStatusProcesso` passando `Hash` + demais parâmetros |
...
_Listar campos na ordem de `<AtualizarStatusProcesso_WSReq>` no WSDL local._

## Parâmetros de entrada

| Campo | Descrição | Tipo | Obrigatório | Condicional | Exemplo |
|-------|-----------|------|-------------|-------------|---------|
| `IdProcesso` | ID do processo | string(50 | — | — | — |
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `AtualizarStatusProcesso`
