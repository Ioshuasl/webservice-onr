...
| Operação SOAP | `ObterXMLSolicitacoes` |
...
| 4 | Chamar `ObterXMLSolicitacoes` passando `Hash` + demais parâmetros |
...
_Listar campos na ordem de `<ObterXMLSolicitacoes_WSReq>` no WSDL local._
...
| 13 | IDPedido inválido, utilize o padrão de número inteiro, ex: 12345 |
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `ObterXMLSolicitacoes`
