...
_Listar campos na ordem de `<SetPrenotacaoExameCalculoAC_WSReq>` no WSDL local._
...
| — | NumeroPrenotacao - Número da prenotação a ser cadastrada | string | — | — | — |
| — | DataPrenotacao - Data da prenotação a ser cadastrada, no formato aaaa-mm-dd | string | — | — | — |
| — | DataVencimento - Data de vencimento da prenotação a ser cadastrada, no formato aaaa-mm-dd | string | — | — | — |
