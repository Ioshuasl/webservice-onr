...
| Operação SOAP | `EnviarAnexoCertidao_DocID` |
...
| 4 | Chamar `EnviarAnexoCertidao_DocID` passando `Hash` + demais parâmetros |
...
_Listar campos na ordem de `<EnviarAnexoCertidao_DocID_WSReq>` no WSDL local._
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `EnviarAnexoCertidao_DocID`
