...
| 4 | Chamar `ListCartoriosRestransmitirOE` passando `Hash` + demais parâmetros |
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `ListCartoriosRestransmitirOE`
