...
| 4 | Chamar `ListStatusIN` passando `Hash` + demais parâmetros |
...
_Listar campos na ordem de `<ListStatusIN_WSReq>` no WSDL local._
...
| `IDStatus` | Código do status | int | — | — | — |
| `NomeStatus` | Descrição/nome do status de intimação | string(30 | — | — | — |
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `ListStatusIN`
