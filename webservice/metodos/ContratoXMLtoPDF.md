...
_Listar campos na ordem de `<ContratoXMLtoPDF_WSReq>` no WSDL local._
...
| `URLArquivo` | URL do Contrato XML | string(300 | — | — | — |
...
| `Arquivo` | String em formato BASE64, contendo os bytes do contrato enviado pela URL convertidos para o formato PDF e com formatação de campos. | — | — | (se RETORNO = true) | — |
