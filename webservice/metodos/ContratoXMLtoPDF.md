...
| Operação SOAP | `ContratoXMLtoPDF` |
...
| 4 | Chamar `ContratoXMLtoPDF` passando `Hash` + demais parâmetros |
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `ContratoXMLtoPDF`
