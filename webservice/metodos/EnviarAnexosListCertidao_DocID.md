...
| Operação SOAP | `EnviarAnexosListCertidao_DocID` |
...
| 4 | Chamar `EnviarAnexosListCertidao_DocID` passando `Hash` + demais parâmetros |
...
_Listar campos na ordem de `<EnviarAnexosListCertidao_DocID_WSReq>` no WSDL local._
...
- [`especificacao_wsoficio_dev.md`](../../especificacao_wsoficio_dev.md) — Envelope de Entrada/Saída `EnviarAnexosListCertidao_DocID`
