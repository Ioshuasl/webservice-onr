...
// <workflow-map>
// Workflow : [AUTOCRA-5] (cra) Cancelamento - Cancelamento
...
@workflow({
    id: 'ADsgeC6405hahbl4',
    name: '[AUTOCRA-5] (cra) Cancelamento - Cancelamento',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra5CraCancelamentoCancelamentoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1310001-0001-4000-8000-000000000001',
        webhookId: 'a1310001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000003',
...
function isXmlCancelamentoValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<cancelamento[\\s>]/i.test(inner)) return false;
  if (!/<\\/cancelamento>/i.test(inner)) return false;
  return true;
}
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^CP[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban CP…DDMM.AAS, ex.: CP0000101.251)');
}
if (!item.user_dados) {
  erros.push('user_dados');
} else if (!isXmlCancelamentoValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <cancelamento>…</cancelamento>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Cancelamento';
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1310001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1310001-0001-4000-8000-00000000000a',
