...
// <workflow-map>
// Workflow : [AUTONRCPN-3] (onrcpn) CertificateFileCreate - Certidão
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveOnrcpnCertificateFileCreate webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
// RespostaErroEntrada                code
// CertificateFileCreateOnrcpn        httpRequest                [onError→regular]
// BuildCertificateFileCreateResponse code
// ReturnCertificateFileCreateResponse respondToWebhook
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// ReceiveOnrcpnCertificateFileCreate
//    → ValidarEntrada
//      → EntradaValida
//        → CertificateFileCreateOnrcpn
//          → BuildCertificateFileCreateResponse
//            → ReturnCertificateFileCreateResponse
//       .out(1) → RespostaErroEntrada
//          → ReturnCertificateFileCreateResponse (↩ loop)
// </workflow-map>
...
@workflow({
    id: 'L2FwhXvCm86fQVPR',
    name: '[AUTONRCPN-3] (onrcpn) CertificateFileCreate - Certidão',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonrcpn3OnrcpnCertificatefilecreateCertidaoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1b30001-0001-4000-8000-000000000001',
        webhookId: 'a1b30001-0001-4000-8000-000000000011',
        name: 'Receive ONRCPN Certificate File Create',
    ...
    ReceiveOnrcpnCertificateFileCreate = {
        httpMethod: 'POST',
        path: 'onrcpn/certificate-file/create',
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000002',
...
const createUrl = baseUrl + '/api/v1.0/certificate-file';
...
`,
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000003',
        name: 'Entrada valida?',
    ...
    EntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'cond-onrcpn-cert-file-create-valido',
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000004',
...
`,
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000005',
        name: 'Certificate File Create ONRCPN',
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000006',
        name: 'Build Certificate File Create Response',
        type: 'n8n-nodes-base.code',
        version: 2,
        position: [1060, 180],
    })
...
function normalizeHttpError(errorObject) {
  const rawMessage = errorObject?.message ?? 'Erro desconhecido ao criar certidao (arquivo) na API ONRCPN.';
  const status = Number(
    errorObject?.status
  ...
  return {
    ...
    response: {
      ...
      detalhe_tecnico: {
        ...
        status: status || null,
        endpoint: meta.endpoint ?? '/api/v1.0/certificate-file',
      },
    },
  };
}
...
`,
    ...
    @node({
        id: 'a1b30001-0001-4000-8000-000000000007',
        name: 'Return Certificate File Create Response',
    ...
    @links()
    defineRouting() {
        this.ReceiveOnrcpnCertificateFileCreate.out(0).to(this.ValidarEntrada.in(0));
        this.ValidarEntrada.out(0).to(this.EntradaValida.in(0));
        this.EntradaValida.out(0).to(this.CertificateFileCreateOnrcpn.in(0));
        this.EntradaValida.out(1).to(this.RespostaErroEntrada.in(0));
        this.CertificateFileCreateOnrcpn.out(0).to(this.BuildCertificateFileCreateResponse.in(0));
        this.BuildCertificateFileCreateResponse.out(0).to(this.ReturnCertificateFileCreateResponse.in(0));
        this.RespostaErroEntrada.out(0).to(this.ReturnCertificateFileCreateResponse.in(0));
    }
}
