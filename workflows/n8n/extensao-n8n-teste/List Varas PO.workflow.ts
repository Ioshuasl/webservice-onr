...
// <workflow-map>
// Workflow : [AUTONR-16] (webservice ONR) ListVarasPO - Penhora Online
...
@workflow({
    id: 'DodTcLzpWBku6yaC',
    name: '[AUTONR-16] (webservice ONR) ListVarasPO - Penhora Online',
    active: false,
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
export class Autonr16WebserviceOnrListvaraspoPenhoraOnlineWorkflow {
    // =====================================================================
