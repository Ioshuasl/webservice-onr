...
// <workflow-map>
// Workflow : [AUTONR-39] (webservice ONR) ListPedidosExportacaoPO_v2 - Penhora Online
...
@workflow({
    id: 'glAAUi0WsfvIvQin',
    name: '[AUTONR-39] (webservice ONR) ListPedidosExportacaoPO_v2 - Penhora Online',
    active: true,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr39WebserviceOnrListpedidosexportacaopoV2PenhoraOnlineWorkflow {
    // =====================================================================
    ...
    @node({
        ...
        webhookId: 'a9b8c7d6-e5f4-4a3b-9c8d-7e6f5a4b3c2d',
        name: 'Webhook',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'a9b8c7d6-e5f4-4a3b-9c8d-7e6f5a4b3c2d',
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <tns:ListPedidosExportacaoPO_v2 xmlns:tns="http://tempuri.org/WSOficio">
      <tns:oRequest>
    ...
    </tns:ListPedidosExportacaoPO_v2>
  </soap:Body>
</soap:Envelope>\`;
