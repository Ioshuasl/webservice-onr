...
// <workflow-map>
// Workflow : [AUTONR-101] (integração) ExclusaoProtocolo - RIB
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveRibExclusaoprotocolo        webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
...
@workflow({
    id: 'rPEIpPQRxOvda4ya',
    name: '[AUTONR-101] (integração) ExclusaoProtocolo - RIB',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr101IntegracaoExclusaoprotocoloRibWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: '42e1dec0-270a-4731-959d-63dfd25b3486',
        webhookId: 'd40e04f4-eec1-4c65-8074-abccc29ee1c6',
        name: 'Receive RIB ExclusaoProtocolo',
    ...
    @node({
        id: '5a864c07-adba-447a-a6a3-55f51408a108',
...
`,
    ...
    @node({
        id: '942a8dfd-1c05-490e-8efd-866a3314cb0e',
        name: 'Entrada valida?',
    ...
    @node({
        id: '42cf8135-d7e8-46a2-a095-03a9839e268a',
    ...
    @node({
        id: '4657bd12-e8fc-4d00-a4ee-26916acf6098',
        name: 'HTTP RIB',
    ...
    @node({
        id: '49b058ca-b715-44e1-97d4-493a3a6df9b2',
        name: 'Build Response',
        type: 'n8n-nodes-base.code',
        version: 2,
        position: [1060, 180],
...
`,
    ...
    @node({
        id: 'dba30aa4-0c7d-4a9e-9998-40a22534c19f',
    ...
    @links()
    defineRouting() {
        this.ReceiveRibExclusaoprotocolo.out(0).to(this.ValidarEntrada.in(0));
