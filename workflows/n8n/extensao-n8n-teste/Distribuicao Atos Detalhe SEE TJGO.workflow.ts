...
// <workflow-map>
// Workflow : [AUTSEETJGO-19] (see tjgo) DistribuicaoAtosDetalhe - Pedido de Atos
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveSeeTjgoDistribuicaoAtosDetalhe webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
// RespostaErroEntrada                code
// DistribuicaoAtosDetalheSeeTjgo     httpRequest                [onError→regular]
// BuildDistribuicaoAtosDetalheResponse code
// ReturnDistribuicaoAtosDetalheResponse respondToWebhook
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// ReceiveSeeTjgoDistribuicaoAtosDetalhe
//    → ValidarEntrada
//      → EntradaValida
//        → DistribuicaoAtosDetalheSeeTjgo
//          → BuildDistribuicaoAtosDetalheResponse
//            → ReturnDistribuicaoAtosDetalheResponse
//       .out(1) → RespostaErroEntrada
//          → ReturnDistribuicaoAtosDetalheResponse (↩ loop)
// </workflow-map>
...
@workflow({
    id: '1vh8vl6HcaMGANQD',
    name: '[AUTSEETJGO-19] (see tjgo) DistribuicaoAtosDetalhe - Pedido de Atos',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autseetjgo19SeeTjgoDistribuicaoatosdetalhePedidoDeAtosWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'e1f20019-0001-4000-8000-000000000001',
        webhookId: 'e1f20019-0001-4000-8000-000000000011',
        name: 'Receive SEE TJGO Distribuicao Atos Detalhe',
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000002',
...
const pedidoUrl = baseUrl + '/distribuicao_de_atos/' + encodeURIComponent(pedidoId);
...
return [{
  json: {
    ...
    meta: {
      ...
      source: 'n8n-see-tjgo-distribuicao-atos-detalhe',
    },
    errorDefaultMsg: 'Erro ao consultar pedido de lote na API SEE TJGO.',
  },
}];
`,
    };
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000003',
        name: 'Entrada valida?',
    ...
    EntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'cond-see-distribuicao-atos-detalhe-valido',
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000004',
...
`,
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000005',
        name: 'Distribuicao Atos Detalhe SEE TJGO',
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000006',
        name: 'Build Distribuicao Atos Detalhe Response',
        type: 'n8n-nodes-base.code',
        version: 2,
        position: [1060, 180],
    })
  ...
  return [{
    json: {
      ...
      response: {
        ...
        mensagem_erro: formatMensagens(parsed) ?? 'A API SEE TJGO rejeitou a consulta do pedido de lote.',
        erros: Array.isArray(parsed) ? parsed : null,
        sistema: 'SEE TJGO',
        status_http: statusCode,
        ambiente: meta.ambiente ?? null,
  ...
  return [{
    json: {
      ...
      response: {
        ...
        mensagem_erro: 'Resposta da API SEE TJGO em formato nao reconhecido (esperado PedidoDoSeloEletronico).',
        sistema: 'SEE TJGO',
        status_http: 502,
        ambiente: meta.ambiente ?? null,
        meta,
...
`,
    ...
    @node({
        id: 'e1f20019-0001-4000-8000-000000000007',
        name: 'Return Distribuicao Atos Detalhe Response',
    ...
    @links()
    defineRouting() {
        this.ReceiveSeeTjgoDistribuicaoAtosDetalhe.out(0).to(this.ValidarEntrada.in(0));
        this.ValidarEntrada.out(0).to(this.EntradaValida.in(0));
        this.EntradaValida.out(0).to(this.DistribuicaoAtosDetalheSeeTjgo.in(0));
        this.EntradaValida.out(1).to(this.RespostaErroEntrada.in(0));
        this.DistribuicaoAtosDetalheSeeTjgo.out(0).to(this.BuildDistribuicaoAtosDetalheResponse.in(0));
        this.BuildDistribuicaoAtosDetalheResponse.out(0).to(this.ReturnDistribuicaoAtosDetalheResponse.in(0));
        this.RespostaErroEntrada.out(0).to(this.ReturnDistribuicaoAtosDetalheResponse.in(0));
    }
}
