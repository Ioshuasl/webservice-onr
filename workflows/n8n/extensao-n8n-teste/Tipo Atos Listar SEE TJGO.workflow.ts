...
// <workflow-map>
// Workflow : [AUTSEETJGO-15] (see tjgo) TipoAtosListar - Tipo Ato
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveSeeTjgoTipoAtosListar       webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
// RespostaErroEntrada                code
// TipoAtosListarSeeTjgo              httpRequest                [onError→regular]
// BuildTipoAtosListarResponse        code
// ReturnTipoAtosListarResponse       respondToWebhook
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// ReceiveSeeTjgoTipoAtosListar
//    → ValidarEntrada
//      → EntradaValida
//        → TipoAtosListarSeeTjgo
//          → BuildTipoAtosListarResponse
//            → ReturnTipoAtosListarResponse
//       .out(1) → RespostaErroEntrada
//          → ReturnTipoAtosListarResponse (↩ loop)
// </workflow-map>
...
@workflow({
    id: 'olI5gOWTuMILofZT',
    name: '[AUTSEETJGO-15] (see tjgo) TipoAtosListar - Tipo Ato',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autseetjgo15SeeTjgoTipoatoslistarTipoAtoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'e1f20015-0001-4000-8000-000000000001',
        webhookId: 'e1f20015-0001-4000-8000-000000000011',
        name: 'Receive SEE TJGO Tipo Atos Listar',
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000002',
...
const tipoAtosUrl = baseUrl + '/tipo_atos';
...
return [{
  json: {
    ...
    meta: {
      ...
      source: 'n8n-see-tjgo-tipo-atos-listar',
    },
    errorDefaultMsg: 'Erro ao listar tipos de ato na API SEE TJGO.',
  },
}];
`,
    };
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000003',
        name: 'Entrada valida?',
    ...
    EntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'cond-see-tipo-atos-listar-valido',
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000004',
...
`,
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000005',
        name: 'Tipo Atos Listar SEE TJGO',
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000006',
        name: 'Build Tipo Atos Listar Response',
        type: 'n8n-nodes-base.code',
        version: 2,
        position: [1060, 180],
    })
  ...
  return {
    ...
    response: {
      ...
      detalhe_tecnico: {
        ...
        status: status || null,
        endpoint: meta.endpoint ?? '/tipo_atos',
      },
      resposta_api: parsed,
    },
  };
  ...
  return [{
    json: {
      ...
      response: {
        ...
        mensagem_erro: formatMensagens(parsed) ?? 'A API SEE TJGO rejeitou a listagem de tipos de ato.',
        erros: Array.isArray(parsed) ? parsed : null,
        sistema: 'SEE TJGO',
        status_http: statusCode,
        ambiente: meta.ambiente ?? null,
...
`,
    ...
    @node({
        id: 'e1f20015-0001-4000-8000-000000000007',
        name: 'Return Tipo Atos Listar Response',
    ...
    @links()
    defineRouting() {
        this.ReceiveSeeTjgoTipoAtosListar.out(0).to(this.ValidarEntrada.in(0));
        this.ValidarEntrada.out(0).to(this.EntradaValida.in(0));
        this.EntradaValida.out(0).to(this.TipoAtosListarSeeTjgo.in(0));
        this.EntradaValida.out(1).to(this.RespostaErroEntrada.in(0));
        this.TipoAtosListarSeeTjgo.out(0).to(this.BuildTipoAtosListarResponse.in(0));
        this.BuildTipoAtosListarResponse.out(0).to(this.ReturnTipoAtosListarResponse.in(0));
        this.RespostaErroEntrada.out(0).to(this.ReturnTipoAtosListarResponse.in(0));
    }
}
