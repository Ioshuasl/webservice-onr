...
// <workflow-map>
// Workflow : [AUTORIB-20] (rib) CancelamentoEditalSimples - RIB
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveRibCancelamentoEditalSimples webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
// RespostaErroEntrada                code
// CancelamentoEditalSimplesRib       httpRequest                [onError→regular]
// BuildCancelamentoEditalResponse    code
// ReturnCancelamentoEditalResponse   respondToWebhook
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// ReceiveRibCancelamentoEditalSimples
//    → ValidarEntrada
//      → EntradaValida
//        → CancelamentoEditalSimplesRib
...
@workflow({
    id: '1si50aAetHpE2rg3',
    name: '[AUTORIB-20] (rib) CancelamentoEditalSimples - RIB',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autorib20RibCancelamentoeditalsimplesRibWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a110b1c2-d3e4-5f6a-7b8c-9d0e1f2a3b4c',
        webhookId: 'b110c3d4-e5f6-a7b8-c9d0-e1f2a3b4c5d6e',
        name: 'Receive RIB Cancelamento Edital Simples',
    ...
    @node({
        id: 'c110d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e',
...
return [{
  json: {
    ...
    meta: {
      ...
      source: 'n8n-rib-cancelamento-edital-simples',
    },
    errorDefaultMsg: 'Erro ao cancelar edital simples na API RIB.',
  },
}];
`,
    };
    ...
    @node({
        id: 'd110e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f',
        name: 'Entrada valida?',
    ...
    EntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'cond-rib-cancelamento-edital-valido',
    ...
    @node({
        id: 'e110f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a',
    ...
    @node({
        id: 'f110a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b',
        name: 'Cancelamento Edital Simples RIB',
    ...
    @node({
        id: 'a110b8c9-d0e1-2f3a-4b5c-6d7e8f9a0b1c',
...
return [{
  json: {
    ...
    response: {
      ...
      mensagem: 'Edital cancelado com sucesso.',
...
`,
    ...
    @node({
        id: 'b110c9d0-e1f2-3a4b-5c6d-7e8f9a0b1c2d',
    ...
    @links()
    defineRouting() {
        this.ReceiveRibCancelamentoEditalSimples.out(0).to(this.ValidarEntrada.in(0));
        this.ValidarEntrada.out(0).to(this.EntradaValida.in(0));
        this.EntradaValida.out(0).to(this.CancelamentoEditalSimplesRib.in(0));
        this.EntradaValida.out(1).to(this.RespostaErroEntrada.in(0));
        this.CancelamentoEditalSimplesRib.out(0).to(this.BuildCancelamentoEditalResponse.in(0));
