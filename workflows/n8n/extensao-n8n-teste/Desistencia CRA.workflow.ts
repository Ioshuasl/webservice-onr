...
// <workflow-map>
// Workflow : [AUTOCRA-4] (cra) Desistencia - Desistência
...
@workflow({
    id: 'Zu7Ltqw1ArQs17C8',
    name: '[AUTOCRA-4] (cra) Desistencia - Desistência',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra4CraDesistenciaDesistenciaWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1300001-0001-4000-8000-000000000001',
        webhookId: 'a1300001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000003',
...
function isXmlDesistenciaValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<desistencia[\\s>]/i.test(inner)) return false;
  if (!/<\\/desistencia>/i.test(inner)) return false;
  return true;
}
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^DP[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban DP…DDMM.AAS, ex.: DP0000101.251)');
}
if (!item.user_dados) {
  erros.push('user_dados');
} else if (!isXmlDesistenciaValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <desistencia>…</desistencia>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Desistencia';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Desistencia soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1300001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1300001-0001-4000-8000-00000000000a',
