...
// <workflow-map>
// Workflow : [AUTONR-8] (webservice ONR) InsertTituloAT - Acompanhamento de Títulos
...
@workflow({
    id: 'JpX3lA5QNgKwehRV',
    name: '[AUTONR-8] (webservice ONR) InsertTituloAT - Acompanhamento de Títulos',
    active: false,
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
export class Autonr8WebserviceOnrInserttituloatAcompanhamentoDeTitulosWorkflow {
    // =====================================================================
