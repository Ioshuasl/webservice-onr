...
// <workflow-map>
// Workflow : [AUTONR-82] (webservice ONR) ListPagamentosIN - Intimações
...
@workflow({
    id: '7fhmwdLzD1Ymw61p',
    name: '[AUTONR-82] (webservice ONR) ListPagamentosIN - Intimações',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr82WebserviceOnrListpagamentosinIntimacoesWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a8820001-0000-4000-8000-000000000001',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'c882i012-1c92-4e5f-b6a7-890123457cde',
    ...
    @node({
        id: 'b8820002-0000-4000-8000-000000000002',
  ...
  "url_servico_onr": "{{ $json.body.url_servico_onr ?? 'https://hml3-wsoficio.onr.org.br/intimacoes.asmx' }}"
    ...
    @node({
        id: 'c8820003-0000-4000-8000-000000000003',
...
return [{ json: {
    ...
    @node({
        id: 'd8820004-0000-4000-8000-000000000004',
    ...
    @node({
        id: 'e8820005-0000-4000-8000-000000000005',
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'f8820006-0000-4000-8000-000000000006',
    ...
    @node({
        id: 'a8820007-0000-4000-8000-000000000007',
...
return { json: {
    ...
    @node({
        id: 'b8820008-0000-4000-8000-000000000008',
...
return [{ json: { status_http: 400, sucesso: false, codigo_erro: item.codigo_erro, mensagem_erro: item.mensagem_erro, dados: { operacao_soap: 'ListPagamentosIN', quantidade_registros: 0, quantidade_paginas: 0, pagamentos: [] } } }];`,
    ...
    @node({
        id: 'c8820009-0000-4000-8000-000000000009',
...
return [{ json: { status_http: 502, sucesso: false, codigo_erro: 0, mensagem_erro: erro.error?.message || erro.message || 'Falha ao conectar com a ONR.', dados: { operacao_soap: 'ListPagamentosIN', quantidade_registros: 0, quantidade_paginas: 0, pagamentos: [] } } }];`,
    ...
    @node({
        id: 'd882000a-0000-4000-8000-000000000001',
