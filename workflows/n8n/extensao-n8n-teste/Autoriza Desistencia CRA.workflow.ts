...
// <workflow-map>
// Workflow : [AUTOCRA-7] (cra) Autoriza_Desistencia - Autorização
...
@workflow({
    id: 'CZ103VGnFsVRUSKW',
    name: '[AUTOCRA-7] (cra) Autoriza_Desistencia - Autorização',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra7CraAutorizaDesistenciaAutorizacaoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1330001-0001-4000-8000-000000000001',
        webhookId: 'a1330001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    return {
      operacao: 'Autoriza_Desistencia',
      soap_op: 'Autoriza_Desistencia',
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000003',
...
function isXmlAutorizaDesistenciaValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<autoriza_desistencia[\\s>]/i.test(inner)) return false;
  if (!/<\\/autoriza_desistencia>/i.test(inner)) return false;
  return true;
}
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^AD[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban AD…DDMM.AAS, ex.: AD0000101.251)');
}
if (!item.user_dados) {
  erros.push('user_dados');
} else if (!isXmlAutorizaDesistenciaValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <autoriza_desistencia>…</autoriza_desistencia>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Autoriza_Desistencia';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Autoriza_Desistencia soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
      <userArq xsi:type="xsd:string">\${esc(item.user_arq)}</userArq>
      <userDados xsi:type="xsd:string">\${userDadosCdata}</userDados>
    </urn:Autoriza_Desistencia>
  </soapenv:Body>
</soapenv:Envelope>\`;
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1330001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1330001-0001-4000-8000-00000000000a',
