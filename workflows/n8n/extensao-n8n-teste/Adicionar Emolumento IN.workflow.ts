...
// <workflow-map>
// Workflow : [AUTONR-80] (webservice ONR) AdicionarEmolumentoIN - Intimações
...
@workflow({
    id: 'Mkh7tSqGMb1uRx2H',
    name: '[AUTONR-80] (webservice ONR) AdicionarEmolumentoIN - Intimações',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr80WebserviceOnrAdicionaremolumentoinIntimacoesWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a8800001-0000-4000-8000-000000000001',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'c880i010-9a70-2c3d-94e5-678901235abc',
    ...
    @node({
        id: 'b8800002-0000-4000-8000-000000000002',
  ...
  "url_servico_onr": "{{ $json.body.url_servico_onr ?? 'https://hml3-wsoficio.onr.org.br/intimacoes.asmx' }}"
    ...
    @node({
        id: 'c8800003-0000-4000-8000-000000000003',
...
return [{ json: { ...item, hash, id_pedido: idPedido, id_status_emolumento: idStatus, descricao, valor, url_servico_onr: urlServico, entrada_valida, codigo_erro, mensagem_erro } }];`,
    ...
    @node({
        id: 'd8800004-0000-4000-8000-000000000004',
    ...
    @node({
        id: 'e8800005-0000-4000-8000-000000000005',
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'f8800006-0000-4000-8000-000000000006',
    ...
    @node({
        id: 'a8800007-0000-4000-8000-000000000007',
...
return { json: {
    ...
    @node({
        id: 'b8800008-0000-4000-8000-000000000008',
...
return [{ json: { status_http: 400, sucesso: false, codigo_erro: item.codigo_erro, mensagem_erro: item.mensagem_erro, dados: { operacao_soap: 'AdicionarEmolumentoIN', id_pedido: item.id_pedido ?? 0, id_status_emolumento: item.id_status_emolumento ?? 0 } } }];`,
    ...
    @node({
        id: 'c8800009-0000-4000-8000-000000000009',
...
return [{ json: { status_http: 502, sucesso: false, codigo_erro: 0, mensagem_erro: erro.error?.message || erro.message || 'Falha ao conectar com a ONR.', dados: { operacao_soap: 'AdicionarEmolumentoIN', id_pedido: erro.id_pedido ?? 0, id_status_emolumento: erro.id_status_emolumento ?? 0 } } }];`,
    ...
    @node({
        id: 'd880000a-0000-4000-8000-000000000001',
