...
// <workflow-map>
// Workflow : [AUTOCRA-3] (cra) Retorno - Retorno
...
@workflow({
    id: 'pn54OjS5xQeUJNzV',
    name: '[AUTOCRA-3] (cra) Retorno - Retorno',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra3CraRetornoRetornoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1290001-0001-4000-8000-000000000001',
        webhookId: 'a1290001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000002',
        ...
        jsonOutput: `={{
  {
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000003',
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^R[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban R…DDMM.AAS, ex.: R3412401.141)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000005',
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Retorno soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000007',
...
const retorno_xml = extrairBloco(xml, 'retorno');
...
return [{
  json: {
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1290001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1290001-0001-4000-8000-00000000000a',
