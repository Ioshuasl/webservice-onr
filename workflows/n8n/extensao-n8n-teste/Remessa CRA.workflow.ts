...
// <workflow-map>
// Workflow : [AUTOCRA-1] (cra) Remessa - Remessa
...
@workflow({
    id: 'rxiP8oRIStvOz9ht',
    name: '[AUTOCRA-1] (cra) Remessa - Remessa',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra1CraRemessaRemessaWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1270001-0001-4000-8000-000000000001',
        webhookId: 'a1270001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000003',
...
function isXmlRemessaValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<remessa[\\s>]/i.test(inner)) return false;
  if (!/<\\/remessa>/i.test(inner)) return false;
  return true;
}
...
} else if (!isXmlRemessaValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <remessa>…</remessa>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000005',
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1270001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1270001-0001-4000-8000-00000000000a',
