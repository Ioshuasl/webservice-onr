...
// <workflow-map>
// Workflow : [AUTOCRA-9] (cra) Consulta - Consulta
...
@workflow({
    id: 'eM9zHTr0SYmczKFG',
    name: '[AUTOCRA-9] (cra) Consulta - Consulta',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra9CraConsultaConsultaWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1350001-0001-4000-8000-000000000001',
        webhookId: 'a1350001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000002',
        ...
        jsonOutput: `={{
  {
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000003',
...
if (!item.nosso_numero && !item.numero_titulo) erros.push('nosso_numero ou numero_titulo');
...
return [{
  json: {
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000005',
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  ...
  <soapenv:Body>
    <urn:Consulta soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
      <nossoNumero xsi:type="xsd:string">\${esc(item.nosso_numero)}</nossoNumero>
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000007',
...
const consultaXml = extrairTag(xml, 'consulta');
const sucesso = ['0000', '0002', '0003'].includes(codigo);
const status_http = consultaXml && !codigo ? 200 : mapearStatusHttpCra(codigo);
return [{
  json: {
    status_http,
    sucesso: sucesso || (consultaXml && !codigo),
    codigo: codigo || (consultaXml ? '0000' : null),
    mensagem: mensagem || (consultaXml ? 'REGISTROS OK' : ''),
    operacao: prev.operacao,
    dados: { consulta: consultaXml || null }
  }
}];`,
    };

    @node({
        id: 'a1350001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1350001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1350001-0001-4000-8000-00000000000a',
