...
// <workflow-map>
// Workflow : [AUTONR-20] (webservice ONR) SetPenhoraAverbadoPO - Penhora Online
...
@workflow({
    id: 'TwgZvrFhqzN7Iesl',
    name: '[AUTONR-20] (webservice ONR) SetPenhoraAverbadoPO - Penhora Online',
    active: false,
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
export class Autonr20WebserviceOnrSetpenhoraaverbadopoPenhoraOnlineWorkflow {
    // =====================================================================
