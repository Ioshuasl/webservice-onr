...
// <workflow-map>
// Workflow : [AUTOCRA-2] (cra) Confirmacao - Confirmação
...
@workflow({
    id: 'CS6XCx46zzr7jHX7',
    name: '[AUTOCRA-2] (cra) Confirmacao - Confirmação',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra2CraConfirmacaoConfirmacaoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1280001-0001-4000-8000-000000000001',
        webhookId: 'a1280001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000002',
        ...
        jsonOutput: `={{
  {
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000003',
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^C[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban C…DDMM.AAS, ex.: C3412401.141)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Confirmacao';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Confirmacao soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000007',
...
const confirmacao_xml = extrairBloco(xml, 'confirmacao');
...
return [{
  json: {
    ...
    dados: {
      ...
      datahora,
      dataoperacao,
      confirmacao_xml: confirmacao_xml || null,
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1280001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1280001-0001-4000-8000-00000000000a',
