...
// <workflow-map>
// Workflow : [AUTOCRA-16] (cra) ConsultaJustificativa - Consulta
...
@workflow({
    id: '16OyU7sRLhlGHOso',
    name: '[AUTOCRA-16] (cra) ConsultaJustificativa - Consulta',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra16CraConsultajustificativaConsultaWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1420001-0001-4000-8000-000000000001',
        webhookId: 'a1420001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000002',
        ...
        jsonOutput: `={{
  {
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000003',
...
return [{
  json: {
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000005',
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000007',
...
function parseJustificativas(xml) {
  const justificativas = [];
  const re = /<justificativa[^>]*>([\\s\\S]*?)<\\/justificativa>/gi;
  let m;
  while ((m = re.exec(xml)) !== null) {
    const bloco = m[1];
    justificativas.push({
      codigo: extrairTag(bloco, 'codigo') || extrairTag(bloco, 'codJustificativa') || null,
      descricao: extrairTag(bloco, 'descricao') || extrairTag(bloco, 'descJustificativa') || null,
    });
  }
...
const justificativas = parseJustificativas(xml);
const sucesso = ['0000', '0002', '0003'].includes(codigo) || (justificativas.length > 0 && !codigo);
const status_http = justificativas.length > 0 && !codigo ? 200 : mapearStatusHttpCra(codigo);
return [{
  json: {
    status_http,
    sucesso,
    codigo: codigo || (justificativas.length > 0 ? '0000' : null),
    mensagem: mensagem || (justificativas.length > 0 ? 'REGISTROS OK' : ''),
    operacao: prev.operacao,
    dados: { justificativas, total: justificativas.length }
  }
}];`,
    };

    @node({
        id: 'a1420001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1420001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1420001-0001-4000-8000-00000000000a',
