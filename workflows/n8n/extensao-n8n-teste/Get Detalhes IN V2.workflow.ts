...
// <workflow-map>
// Workflow : [AUTONR-76] (webservice ONR) GetDetalhesIN_V2 - Intimações
...
@workflow({
    id: 'OKXLR0de2SXoYSKH',
    name: '[AUTONR-76] (webservice ONR) GetDetalhesIN_V2 - Intimações',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr76WebserviceOnrGetdetalhesinV2IntimacoesWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a8760001-0000-4000-8000-000000000001',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'c876i008-7e5f-0a1b-82c3-456789013abc',
    ...
    @node({
        id: 'b8760002-0000-4000-8000-000000000002',
  ...
  "url_servico_onr": "{{ $json.body.url_servico_onr ?? 'https://hml3-wsoficio.onr.org.br/intimacoes.asmx' }}"
    ...
    @node({
        id: 'c8760003-0000-4000-8000-000000000003',
...
return [{ json: { ...item, hash, id_pedido: idPedido, url_servico_onr: urlServico, entrada_valida, codigo_erro, mensagem_erro } }];`,
    ...
    @node({
        id: 'd8760004-0000-4000-8000-000000000004',
    ...
    @node({
        id: 'e8760005-0000-4000-8000-000000000005',
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'f8760006-0000-4000-8000-000000000006',
    ...
    @node({
        id: 'a8760007-0000-4000-8000-000000000007',
...
return { json: {
    ...
    @node({
        id: 'b8760008-0000-4000-8000-000000000008',
...
return [{ json: { status_http: 400, sucesso: false, codigo_erro: item.codigo_erro, mensagem_erro: item.mensagem_erro, dados: { id_pedido: item.id_pedido ?? 0, operacao_soap: 'GetDetalhesIN_V2' } } }];`,
    ...
    @node({
        id: 'c8760009-0000-4000-8000-000000000009',
...
return [{ json: { status_http: 502, sucesso: false, codigo_erro: 0, mensagem_erro: erro.error?.message || erro.message || 'Falha ao conectar com a ONR.', dados: { id_pedido: erro.id_pedido ?? 0, operacao_soap: 'GetDetalhesIN_V2' } } }];`,
    ...
    @node({
        id: 'd876000a-0000-4000-8000-000000000001',
