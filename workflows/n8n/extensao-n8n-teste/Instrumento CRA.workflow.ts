...
// <workflow-map>
// Workflow : [AUTOCRA-11] (cra) Instrumento - Instrumento
...
@workflow({
    id: 'hwBubo0sOrSh72BU',
    name: '[AUTOCRA-11] (cra) Instrumento - Instrumento',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra11CraInstrumentoInstrumentoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1370001-0001-4000-8000-000000000001',
        webhookId: 'a1370001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000003',
...
function isXmlInstrumentoValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<instrumento[\\s>]/i.test(inner)) return false;
  if (!/<\\/instrumento>/i.test(inner)) return false;
  return true;
}
...
} else if (!isXmlInstrumentoValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <instrumento>…</instrumento>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Instrumento';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Instrumento soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000007',
...
const nome_arquivo = extrairTag(xml, 'nome_arquivo') || extrairTag(xml, 'nome arquivo') || null;
const datahora = extrairTag(xml, 'datahora') || null;
const dataoperacao = extrairTag(xml, 'dataoperacao') || null;
const instrumento_xml = extrairBloco(xml, 'instrumento') || extrairBloco(xml, 'Instrumento');
const sucesso = ['0000', '0002', '0003'].includes(codigo) || (!!instrumento_xml && !codigo);
const status_http = instrumento_xml && !codigo ? 200 : mapearStatusHttpCra(codigo);
return [{
  json: {
    status_http,
    sucesso,
    codigo: codigo || (instrumento_xml ? '0000' : null),
    ...
    dados: {
      ...
      datahora,
      dataoperacao,
      instrumento_xml: instrumento_xml || null
    }
  }
}];`,
    };
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1370001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1370001-0001-4000-8000-00000000000a',
