...
// <workflow-map>
// Workflow : [AUTONR-66] (webservice ONR) SetPrenotacaoExameCalculoAC - E-Protocolo
...
@workflow({
    id: 'WKuh176ngZlO1Cs1',
    name: '[AUTONR-66] (webservice ONR) SetPrenotacaoExameCalculoAC - E-Protocolo',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr66WebserviceOnrSetprenotacaoexamecalculoacEProtocoloWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'c5d6e7f8-a9b0-4123-c456-789abcdef014',
        webhookId: 'f6a7b8c9-e0f1-4a2b-3c4d-5e6f7a8b9c0f',
        name: 'Webhook',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'f6a7b8c9-e0f1-4a2b-3c4d-5e6f7a8b9c0f',
    ...
    @node({
        id: 'd6e7f8a9-b0c1-4234-d567-89abcdef0125',
 ...
 `,
    ...
    @node({
        id: 'e7f8a9b0-c1d2-4345-e678-9abcdef01236',
...
return [{
    ...
    @node({
        id: 'f8a9b0c1-d2e3-4456-f789-0abcdef12347',
    ...
    IfEntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'a9b0c1d2-e3f4-4567-a890-1abcdef23458',
    ...
    @node({
        id: 'b0c1d2e3-f4a5-4678-b901-2abcdef34569',
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <tns:SetPrenotacaoExameCalculoAC xmlns:tns="http://tempuri.org/WSOficio">
      <tns:oRequest>
...
\${senhaXml}      </tns:oRequest>
    </tns:SetPrenotacaoExameCalculoAC>
  </soap:Body>
</soap:Envelope>\`;
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'c1d2e3f4-a5b6-4789-c012-3abcdef4567a',
    ...
    @node({
        id: 'd2e3f4a5-b6c7-4890-d123-4abcdef5678b',
...
return {
    ...
    @node({
        id: 'e3f4a5b6-c7d8-4901-e234-5abcdef6789c',
...
return [{
    ...
    @node({
        id: 'f4a5b6c7-d8e9-4901-f345-6abcdef7890d',
...
return [{
    ...
    @node({
        id: 'a5b6c7d8-e9f0-4901-a456-7abcdef8901e',
