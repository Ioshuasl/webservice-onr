...
// <workflow-map>
// Workflow : [AUTONR-81] (webservice ONR) ExcluirEmolumentoIN - Intimações
...
@workflow({
    id: '9TYoAJODBYdEm1FF',
    name: '[AUTONR-81] (webservice ONR) ExcluirEmolumentoIN - Intimações',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr81WebserviceOnrExcluiremolumentoinIntimacoesWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a8810001-0000-4000-8000-000000000001',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'c881i011-0b81-3d4e-a5f6-789012346bcd',
    ...
    @node({
        id: 'b8810002-0000-4000-8000-000000000002',
  ...
  "url_servico_onr": "{{ $json.body.url_servico_onr ?? 'https://hml3-wsoficio.onr.org.br/intimacoes.asmx' }}"
    ...
    @node({
        id: 'c8810003-0000-4000-8000-000000000003',
...
return [{ json: { ...item, hash, id_emolumento: idEmolumento, url_servico_onr: urlServico, entrada_valida, codigo_erro, mensagem_erro } }];`,
    ...
    @node({
        id: 'd8810004-0000-4000-8000-000000000004',
    ...
    @node({
        id: 'e8810005-0000-4000-8000-000000000005',
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'f8810006-0000-4000-8000-000000000006',
    ...
    @node({
        id: 'a8810007-0000-4000-8000-000000000007',
...
return { json: {
    ...
    @node({
        id: 'b8810008-0000-4000-8000-000000000008',
...
return [{ json: { status_http: 400, sucesso: false, codigo_erro: item.codigo_erro, mensagem_erro: item.mensagem_erro, dados: { operacao_soap: 'ExcluirEmolumentoIN', id_emolumento: item.id_emolumento ?? 0 } } }];`,
    ...
    @node({
        id: 'c8810009-0000-4000-8000-000000000009',
...
return [{ json: { status_http: 502, sucesso: false, codigo_erro: 0, mensagem_erro: erro.error?.message || erro.message || 'Falha ao conectar com a ONR.', dados: { operacao_soap: 'ExcluirEmolumentoIN', id_emolumento: erro.id_emolumento ?? 0 } } }];`,
    ...
    @node({
        id: 'd881000a-0000-4000-8000-000000000001',
