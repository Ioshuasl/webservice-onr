...
// <workflow-map>
// Workflow : [AUTOCRA-6] (cra) Autoriza_Cancelamento - Autorização
...
@workflow({
    id: 'MXWDzKFaOgWKMXKr',
    name: '[AUTOCRA-6] (cra) Autoriza_Cancelamento - Autorização',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra6CraAutorizaCancelamentoAutorizacaoWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1320001-0001-4000-8000-000000000001',
        webhookId: 'a1320001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'cra/autoriza-cancelamento',
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    return {
      operacao: 'Autoriza_Cancelamento',
      soap_op: 'Autoriza_Cancelamento',
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000003',
...
function isXmlAutorizaCancelamentoValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<autoriza_cancelamento[\\s>]/i.test(inner)) return false;
  if (!/<\\/autoriza_cancelamento>/i.test(inner)) return false;
  return true;
}
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^AC[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban AC…DDMM.AAS, ex.: AC0000101.251)');
}
if (!item.user_dados) {
  erros.push('user_dados');
} else if (!isXmlAutorizaCancelamentoValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <autoriza_cancelamento>…</autoriza_cancelamento>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Autoriza_Cancelamento';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Autoriza_Cancelamento soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
      <userArq xsi:type="xsd:string">\${esc(item.user_arq)}</userArq>
      <userDados xsi:type="xsd:string">\${userDadosCdata}</userDados>
    </urn:Autoriza_Cancelamento>
  </soapenv:Body>
</soapenv:Envelope>\`;
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1320001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1320001-0001-4000-8000-00000000000a',
