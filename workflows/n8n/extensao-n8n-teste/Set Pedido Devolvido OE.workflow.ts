...
@workflow({
    id: 'MislADZad80qNGws',
    name: 'Set Pedido Devolvido OE',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class SetPedidoDevolvidoOeWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: '2acbf89d-c4b1-4a82-9f8d-71a407ea09dd',
        webhookId: 'f34f2f9f-6c01-475e-9871-ebd36e714f67',
        name: 'Webhook',
    ...
    Webhook = {
        httpMethod: 'POST',
        path: 'f34f2f9f-6c01-475e-9871-ebd36e714f67',
    ...
    @node({
        id: 'f65a5698-408c-48f3-b6f0-23d0ed9762cf',
  ...
  motivo_devolucao: $json.body.motivo_devolucao ?? '',
 ...
 `,
    ...
    @node({
        id: '2c84d245-b78d-4c53-8cb1-a983ec117084',
...
const motivoDevolucao = String(item.motivo_devolucao ?? '').trim();
...
} else if (!motivoDevolucao) {
    entrada_valida = false;
    codigo_erro = 13;
    mensagem_erro = 'motivo_devolucao e obrigatorio.';
} else if (!urlServico) {
    entrada_valida = false;
    codigo_erro = 10;
...
return [{
    ...
    @node({
        id: '1266a9b7-e754-4d8d-b4ea-32948ef472e6',
    ...
    IfEntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: '1b7f4166-0dca-48f9-9a9e-a9ef4aa89d85',
    ...
    @node({
        id: '5f6438f5-a701-43f4-bc93-0440353a3d06',
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <tns:SetPedidoDevolvidoOE xmlns:tns="http://tempuri.org/WSOficio">
      <tns:oRequest>
        <tns:Hash>\${escapeXml(item.hash)}</tns:Hash>
        <tns:IDPedido>\${item.id_pedido}</tns:IDPedido>
        <tns:MotivoDevolucao>\${escapeXml(item.motivo_devolucao)}</tns:MotivoDevolucao>
      </tns:oRequest>
    </tns:SetPedidoDevolvidoOE>
  </soap:Body>
</soap:Envelope>\`;
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: '5b7ff36c-13d0-44cf-bcb8-b146ef03e51c',
    ...
    @node({
        id: 'b2a7af71-0a5f-4f7f-bad1-c8f8a28dc1af',
...
function dadosPadrao(sucesso = false) {
    return {
        ...
        motivo_devolucao: entrada.motivo_devolucao ?? '',
        devolvido: sucesso
    };
}
...
return {
    ...
    @node({
        id: '59153c4e-2748-4556-b594-4098f8ba3ad4',
...
return [{
    ...
    @node({
        id: '0eb8caaf-7f68-4b98-9716-d3abf69f3007',
...
return [{
    json: {
        ...
        dados: {
            ...
            motivo_devolucao: erro.motivo_devolucao ?? '',
            devolvido: false
        }
    }
}];`,
    ...
    @node({
        id: '0bdf269f-5dd8-4379-bf27-cd8ec75a34ec',
