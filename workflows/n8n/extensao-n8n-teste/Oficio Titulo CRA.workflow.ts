...
// <workflow-map>
// Workflow : [AUTOCRA-15] (cra) Oficio_Titulo - Ofício
...
@workflow({
    id: 'Qsemjs7WDHNgvmtD',
    name: '[AUTOCRA-15] (cra) Oficio_Titulo - Ofício',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autocra15CraOficioTituloOficioWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a1410001-0001-4000-8000-000000000001',
        webhookId: 'a1410001-0001-4000-8000-000000000011',
        name: 'Webhook',
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000002',
  ...
  (() => {
    ...
    return {
      operacao: 'Oficio_Titulo',
      soap_op: 'Oficio_Titulo',
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000003',
...
function isXmlOficioValid(s) {
  const inner = stripCdata(s);
  if (!inner) return false;
  if (!/<oficio[\\s>]/i.test(inner)) return false;
  if (!/<\\/oficio>/i.test(inner)) return false;
  return true;
}
...
if (!item.user_arq) {
  erros.push('user_arq');
} else if (!/^OT[A-Z0-9]+\\.[0-9]+$/i.test(item.user_arq)) {
  erros.push('user_arq (padrão Febraban OT…DDMM.AAS, ex.: OT0000101.251)');
}
if (!item.user_dados) {
  erros.push('user_dados');
} else if (!isXmlOficioValid(item.user_dados)) {
  erros.push('user_dados (XML válido com raiz <oficio>…</oficio>)');
}
...
return [{
  json: {
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000004',
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000005',
...
const soapAction = ns + '#Oficio_Titulo';
...
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="\${ns}">
  <soapenv:Header/>
  <soapenv:Body>
    <urn:Oficio_Titulo soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
...
return [{ json: { ...item, cra_soap_url: url, cra_soap_action: soapAction, cra_soap_body: body, cra_auth_header } }];`,
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000006',
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000007',
...
return [{
  json: {
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000008',
...
return [{
  json: {
    ...
    @node({
        id: 'a1410001-0001-4000-8000-000000000009',
...
return [{
  json: {
    ...
    @node({
        id: 'a1410001-0001-4000-8000-00000000000a',
