...
// <workflow-map>
// Workflow : [AUTORIB-23] (rib) RetificacaoEditalLeilao - RIB
// Nodes   : 7  |  Connections: 7
//
// NODE INDEX
// ──────────────────────────────────────────────────────────────────
// Property name                    Node type (short)         Flags
// ReceiveRibRetificacaoEditalLeilao  webhook                    [creds]
// ValidarEntrada                     code
// EntradaValida                      if
// RespostaErroEntrada                code
// RetificacaoEditalLeilaoRib         httpRequest                [onError→regular]
// BuildRetificacaoEditalResponse     code
// ReturnRetificacaoEditalResponse    respondToWebhook
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// ReceiveRibRetificacaoEditalLeilao
//    → ValidarEntrada
//      → EntradaValida
//        → RetificacaoEditalLeilaoRib
...
@workflow({
    id: 'EpVUICl4P39XzDYp',
    name: '[AUTORIB-23] (rib) RetificacaoEditalLeilao - RIB',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autorib23RibRetificacaoeditalleilaoRibWorkflow {
    // =====================================================================
    // CONFIGURATION DES NOEUDS
    // =====================================================================

    @node({
        id: 'a113b1c2-d3e4-5f6a-7b8c-9d0e1f2a3b4c',
        webhookId: 'b113c3d4-e5f6-a7b8-c9d0-e1f2a3b4c5d6e',
        name: 'Receive RIB Retificacao Edital Leilao',
    ...
    ReceiveRibRetificacaoEditalLeilao = {
        httpMethod: 'PUT',
        path: 'rib/edital/leilao/retificacao',
    ...
    @node({
        id: 'c113d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e',
...
if (!payload) {
  return erro(422, 'body_invalido', 'Envie JSON com os campos do edital leilao (RFL-03 / RFL-01).', null);
}
...
return [{
  json: {
    ...
    meta: {
      ...
      source: 'n8n-rib-retificacao-edital-leilao',
    },
    errorDefaultMsg: 'Erro ao retificar edital leilao na API RIB.',
  },
}];
`,
    };
    ...
    @node({
        id: 'd113e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f',
        name: 'Entrada valida?',
    ...
    EntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'cond-rib-retificacao-edital-leilao-valido',
    ...
    @node({
        id: 'e113f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a',
    ...
    @node({
        id: 'f113a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b',
        name: 'Retificacao Edital Leilao RIB',
    ...
    @node({
        id: 'a113b8c9-d0e1-2f3a-4b5c-6d7e8f9a0b1c',
...
`,
    ...
    @node({
        id: 'b113c9d0-e1f2-3a4b-5c6d-7e8f9a0b1c2d',
    ...
    @links()
    defineRouting() {
        this.ReceiveRibRetificacaoEditalLeilao.out(0).to(this.ValidarEntrada.in(0));
        this.ValidarEntrada.out(0).to(this.EntradaValida.in(0));
        this.EntradaValida.out(0).to(this.RetificacaoEditalLeilaoRib.in(0));
        this.EntradaValida.out(1).to(this.RespostaErroEntrada.in(0));
        this.RetificacaoEditalLeilaoRib.out(0).to(this.BuildRetificacaoEditalResponse.in(0));
