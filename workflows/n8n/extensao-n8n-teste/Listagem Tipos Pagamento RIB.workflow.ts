...
// <workflow-map>
// Workflow : [AUTORIB-30] (rib) ListagemTiposPagamento - RIB
...
@workflow({
    id: '1C9hQMPCfrBuaJ78',
    name: '[AUTORIB-30] (rib) ListagemTiposPagamento - RIB',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autorib30RibListagemtipospagamentoRibWorkflow {
    // =====================================================================
