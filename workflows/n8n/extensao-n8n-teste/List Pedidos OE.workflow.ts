...
export class ListPedidosOeWorkflow {
    ...
    @node({
        id: 'd4e5f6a7-b8c9-4d0e-91f2-a3b4c5d6e7a1',
        webhookId: 'c4d5e6f7-a8b9-4c0d-9e1f-a2b3c4d5e6f8',
        name: 'Webhook',
    ...
    @node({
        id: 'e5f6a7b8-c9d0-4e1f-a2b3-c4d5e6f7a8b2',
 ...
 `,
    ...
    @node({
        id: 'f6a7b8c9-d0e1-4f2a-b3c4-d5e6f7a8b9c3',
...
return [{
    ...
    @node({
        id: 'a7b8c9d0-e1f2-4a3b-84c5-d6e7f8a9b0d4',
    ...
    IfEntradaValida = {
        conditions: {
            ...
            conditions: [
                {
                    id: 'b8c9d0e1-f2a3-4b4c-95d6-e7f8a9b0c1e5',
    ...
    @node({
        id: 'b8c9d0e1-f2a3-4b4c-95d6-e7f8a9b0c1f6',
...
return [{ json: { ...item, corpo_soap: corpo } }];`,
    ...
    @node({
        id: 'c9d0e1f2-a3b4-4c5d-a6e7-f8a9b0c1d2a7',
    ...
    @node({
        id: 'd0e1f2a3-b4c5-4d6e-b7f8-a9b0c1d2e3b8',
...
function parsePedidos(origem) {
    const blocos = [
        ...extrairBlocos('ListPedidosOE_V2_Pedidos_WSResp', origem),
        ...extrairBlocos('ListPedidosOE_Pedidos_WSResp', origem)
    ];
...
return {
    ...
    @node({
        id: 'e1f2a3b4-c5d6-4e7f-88a9-b0c1d2e3f4c9',
...
return [{
    ...
    @node({
        id: 'f2a3b4c5-d6e7-4f8a-99b0-c1d2e3f4a5d0',
...
return [{
    ...
    @node({
        id: 'a3b4c5d6-e7f8-4a9b-b0c1-d2e3f4a5b6e1',
