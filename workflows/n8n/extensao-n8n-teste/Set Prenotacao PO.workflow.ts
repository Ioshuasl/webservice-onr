...
// <workflow-map>
// Workflow : [AUTONR-17] (webservice ONR) SetPrenotacaoPO - Penhora Online
...
@workflow({
    id: 'A6wY7hn5NygVc1LZ',
    name: '[AUTONR-17] (webservice ONR) SetPrenotacaoPO - Penhora Online',
    active: false,
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
export class Autonr17WebserviceOnrSetprenotacaopoPenhoraOnlineWorkflow {
    // =====================================================================
