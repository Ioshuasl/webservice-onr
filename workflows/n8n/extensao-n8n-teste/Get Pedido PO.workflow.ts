...
// <workflow-map>
// Workflow : [AUTONR-15] (webservice ONR) GetPedidoPO - Penhora Online
...
@workflow({
    id: '6du4sS2cZBhagiEu',
    name: '[AUTONR-15] (webservice ONR) GetPedidoPO - Penhora Online',
    active: false,
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
export class Autonr15WebserviceOnrGetpedidopoPenhoraOnlineWorkflow {
    // =====================================================================
