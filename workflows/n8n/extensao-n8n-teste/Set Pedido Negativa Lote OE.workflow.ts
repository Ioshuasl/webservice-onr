...
// <workflow-map>
// Workflow : [AUTONR-36] (webservice ONR) SetPedidoNegativaLoteOE - Ofício Eletrônico
...
@workflow({
    id: 'ergNGHwTWWl6rPpa',
    name: '[AUTONR-36] (webservice ONR) SetPedidoNegativaLoteOE - Ofício Eletrônico',
    active: false,
    isArchived: false,
    settings: { executionOrder: 'v1', availableInMCP: false, callerPolicy: 'workflowsFromSameOwner' },
})
export class Autonr36WebserviceOnrSetpedidonegativaloteoeOficioEletronicoWorkflow {
    // =====================================================================
